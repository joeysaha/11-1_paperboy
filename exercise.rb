...
updated = project
# puts project.values_at(:steps)[0][3].values_at(:due_date)
# project.values_at(:steps)[0][3][:person] = project.values_at(:committee)[0][rand(0..2)]
project.values_at(:steps)[0].each do |a|
  a[:person] = project.values_at(:committee)[0][rand(0..2)]
end
puts project
